...
SLUG="tabletop-events-resources"
OUT="${ROOT}/dist"
mkdir -p "${OUT}"
...
# slug, e.g. tabletop-events-resources/tabletop-events-resources.php rather than loose
# files at the zip root, or GitHub's own "Download ZIP" folder name
# (tabletop-events-resources-main/). WordPress needs that single top-level
